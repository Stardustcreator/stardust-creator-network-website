import { 
  // Person,  // Commented out unused import
  Organization, 
  WebSite, 
  WebPage, 
  Service, 
...
export const generateOrganizationSchema = (): Organization => ({
  ...
  'description': 'A dynamic platform connecting innovative creators with global brands, fostering collaborative and impactful digital experiences.',
  'foundingDate': '2023',
  'founders': [{
    '@type': 'Person',
...
export const generateWebSiteSchema = (): WebSite => ({
  ...
  'name': 'Stardust Creators Network',
  'url': 'https://www.stardustcreators.com',
  'description': 'Empowering digital creators through innovative collaboration and strategic networking',
...
export const generateWebPageSchema = (pageTitle: string, pageDescription: string, pageUrl: string): WebPage => ({
  '@type': 'WebPage',
  'name': pageTitle,
...
export const generateServiceSchema = (serviceName: string, serviceDescription: string): Service => ({
  '@type': 'Service',
  'name': serviceName,
