...
const sidebarItems: SidebarItem[] = [
  ...
  { id: 'brand-creator-collaborations', label: 'Brand & Creator Collaborations' },
...
export default function TermsOfServiceSidebar() {
  const [activeSection, setActiveSection] = useState<string>('platform-use');
