          ...
          <div className="max-w-4xl mx-auto space-y-8 md:space-y-12">
            ...
            <section className="space-y-4">
              ...
              <p className="text-white/80 leading-relaxed text-base md:text-lg">
                ...
                were counterfeit, leading to widespread confusion and sales decline. With Nigeria in
                the heat of a counterfeit product crisis, the brand needed immediate damage control
                and consumer education to restore trust.
              </p>
            </section>
            ...
            <section className="space-y-6 pt-8 md:pt-12 border-t border-white/10">
              ...
              <div className="w-full space-y-6">
                ...
                <div className="space-y-4">
                  <h4 className="text-lg md:text-xl text-white font-semibold">Campaign Overview</h4>
                  <p className="text-white/80 leading-relaxed text-base md:text-lg">
                    Honeywell redesigned their product packaging but customers thought the new packs
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white/80 leading-relaxed text-base md:text-lg">
                    Folagade Banks&apos; &quot;Mama Deola&quot; character commanded 1.8M impressions
                    with 18.52% engagement and a 63.61% female audience - perfect for reaching
                    Nigerian households. His authentic, humorous approach directly addressed the
                    packaging concerns while demonstrating product quality.
                  </p>
                </div>
            ...
            <section className="space-y-6 pt-8 md:pt-12 border-t border-white/10">
              ...
              <div className="w-full space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white/80 leading-relaxed text-base md:text-lg">
                    Omoba&apos;s authentic storytelling and her highly engaging audience was perfect
                    for reaching Nigerian households. Her authentic, humorous skit approach directly
                    addressed the product redesign while resounding product quality.
                  </p>
                </div>
