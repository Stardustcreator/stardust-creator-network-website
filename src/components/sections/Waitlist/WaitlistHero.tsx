...
export default function WaitlistHero() {
  ...
  return (
    <section className="hero-fullwidth relative min-h-[85vh] sm:min-h-[90vh] md:min-h-[95vh] overflow-hidden bg-black rounded-br-[40px] rounded-bl-[40px]">
      ...
      {/* Content */}
      <div className="relative z-20 flex flex-col justify-center min-h-[85vh] sm:min-h-[90vh] md:min-h-[95vh] px-6 py-20 md:px-8 md:py-24 lg:px-12 lg:py-28 max-w-5xl mx-auto">
        {/* Main Headline */}
        <Heading
          level={1}
          variant="default"
