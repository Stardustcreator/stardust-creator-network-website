...
interface CreatorOsHeroProps {
  title?: string;
  subtitle?: string;
  buttonText?: string;
}

const DEFAULT_TITLE = 'Everything You Need to Run Your Creator Business, Finally in One Place';
const DEFAULT_SUBTITLE =
  'When your tools are scattered, your business feels scattered. SCN gives you one place to price your work, get paid, grow your audience, & connect with brands.';
const DEFAULT_BUTTON_TEXT = 'Join the Network';

export default function CreatorOsHero({
  title = DEFAULT_TITLE,
