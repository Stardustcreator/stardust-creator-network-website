/**
 * Early Capture API for Creator Applications
...
const earlyCreatorCaptureSchema = z.object({
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validatedData = earlyCreatorCaptureSchema.parse(body);
    ...
    // Add to Mailchimp with partial-creator-signup tag
    ...
    console.log('Early capture successful for creator:', {
      email: validatedData.email,
