...
const DEFAULT_HERO_TITLE = 'Find the Right Creators for Your Campaign';
const DEFAULT_HERO_SUBTITLE =
  'Brief us. We match you with vetted Nigerian creators, handle the coordination, and deliver the shortlist within your timeline.';
const DEFAULT_FINAL_CTA_TITLE = 'Ready to Find Creators Who Help You Achieve Your Campaign Goals?';
...
interface FindCreatorsContentProps {
  heroTitle?: string;
  heroSubtitle?: string;
...
export default function FindCreatorsContent({
  heroTitle = DEFAULT_HERO_TITLE,
  heroSubtitle = DEFAULT_HERO_SUBTITLE,
  processSteps = DEFAULT_PROCESS_STEPS,
  finalCtaTitle = DEFAULT_FINAL_CTA_TITLE,
}: FindCreatorsContentProps) {
  const cards = processSteps;
